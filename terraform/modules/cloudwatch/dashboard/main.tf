locals {
  dashboard_name = replace("${var.name}", "_", "-")
}
   ...
   "widgets":[
      ...
      },
      {
         ...
         "properties":{
            ...
            "stacked":false,
            "metrics":[
               [ "AWS/ECS", "MemoryUtilization", "ServiceName", "${var.name}_api", "ClusterName", "${var.name}", { "label": "Minimum", "stat": "Minimum", "color": "#2ca02c" } ],
      ...
      },
      {
         ...
         "properties":{
            ...
            "stacked":false,
            "metrics":[
               [ "AWS/ECS", "CPUUtilization", "ServiceName", "${var.name}_api", "ClusterName", "${var.name}", { "label": "Maximum", "stat": "Maximum" } ],
               [ "...", { "stat": "Average", "label": "Average" } ],
