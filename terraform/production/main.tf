...
module "ecs" {
  ...
  ses_api_key_arn                    = module.ssm.ses_api_key_arn
  ses_region_arn                     = module.ssm.ses_region_arn
  s3_secret_key_arn                  = module.ssm.s3_secret_key_arn
  s3_api_key_arn                     = module.ssm.s3_api_key_arn
...
module "codebuild-log" {
  ...
  s3_bucket = module.s3.codebuild_bucket_id
  schedule  = "cron(0 10 * * ? *)"
}
